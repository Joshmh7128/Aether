...
instance_create(x,y,effect_playerLighting_long_v)
//instance_create_depth(x,y,-998,effect_playerLighting_OLD)

instance_create_depth(x,y+208,-1100,effect_wall_highlight)
instance_create_depth(x,y+192,-1100,effect_wall_highlight)
instance_create_depth(x,y+160,-1100,effect_wall_highlight)
